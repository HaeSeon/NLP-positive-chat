from flask import Flask     #flask에서 FLask라는 class를 import. 이 클래스가 WSGI(Web Server Gateway Interface)
...
tokenizer = BertTokenizer.from_pretrained('bert-base-multilingual-cased')   #입력 문 토크나이징
...
def res_predict():
    ...
    # print( tokenizer.tokenize("보는내내 그대로 들어맞는 예측 카리스마 없는 악"))
